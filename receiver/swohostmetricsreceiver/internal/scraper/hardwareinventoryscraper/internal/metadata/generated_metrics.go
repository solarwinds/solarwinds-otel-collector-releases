...
// init fills swo.hardwareinventory.cpu metric with initial data.
func (m *metricSwoHardwareinventoryCPU) init() {
	m.data.SetName("swo.hardwareinventory.cpu")
	m.data.SetDescription("CPU current clock speed in MHz.")
	m.data.SetUnit("MHz")
...
func (m *metricSwoHardwareinventoryCPU) recordDataPoint(start pcommon.Timestamp, ts pcommon.Timestamp, val int64, processorNameAttributeValue string, processorCaptionAttributeValue string, processorManufacturerAttributeValue string, processorModelAttributeValue string, processorSteppingAttributeValue string, processorCoresAttributeValue string, processorThreadsAttributeValue string) {
	...
	dp.SetTimestamp(ts)
	dp.SetIntValue(val)
	dp.Attributes().PutStr("processor.name", processorNameAttributeValue)
	dp.Attributes().PutStr("processor.caption", processorCaptionAttributeValue)
	dp.Attributes().PutStr("processor.manufacturer", processorManufacturerAttributeValue)
	dp.Attributes().PutStr("processor.model", processorModelAttributeValue)
...
func (m *metricSwoHardwareinventoryCPU) updateCapacity() {
...
func (m *metricSwoHardwareinventoryCPU) emit(metrics pmetric.MetricSlice) {
...
type MetricsBuilder struct {
	...
	metricSwoHardwareinventoryCPU metricSwoHardwareinventoryCPU
}
...
func NewMetricsBuilder(mbc MetricsBuilderConfig, settings scraper.Settings, options ...MetricBuilderOption) *MetricsBuilder {
	mb := &MetricsBuilder{
		...
		metricSwoHardwareinventoryCPU: newMetricSwoHardwareinventoryCPU(mbc.Metrics.SwoHardwareinventoryCPU),
	}
...
func (mb *MetricsBuilder) EmitForResource(options ...ResourceMetricsOption) {
	...
	ils.Scope().SetName("github.com/solarwinds/solarwinds-otel-collector-releases/receiver/swohostmetricsreceiver/internal/scraper/hardwareinventoryscraper")
