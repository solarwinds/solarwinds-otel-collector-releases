...
// generated using [System.Globalization.CultureInfo]::GetCultures([System.Globalization.CultureTypes]::AllCultures).
func getDisplayLanguages() map[string]string {
