module github.com/solarwinds/solarwinds-otel-collector-releases/processor/swok8sworkloadtypeprocessor

go 1.24.2

require (
	github.com/solarwinds/solarwinds-otel-collector-releases/internal/k8sconfig v0.123.1
