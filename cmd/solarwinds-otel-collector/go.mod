...
require (
	...
	github.com/solarwinds/solarwinds-otel-collector/receiver/swohostmetricsreceiver v0.113.0
...
require (
	...
	github.com/solarwinds/solarwinds-otel-collector/pkg/testutil v0.113.0 // indirect
