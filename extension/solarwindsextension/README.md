...
- `without_entity` (optional) - You can disable Collector entity creation in Solarwinds Observability, by setting it to `true`. Otherwise, entity creation is enabled by default.
## Development
